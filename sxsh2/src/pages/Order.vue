        ...
        >
            <template #bodyCell="{ column, text, record }">
                 <template v-if="column.key === 'action'">
                    <span>
                    <EditOutlined :style="{fontSize: '16px', color: '#08c'}" @click="goodsModalRef.showGoodsModal(record.sBarCode)"/>
                    <a-divider type="vertical" />
                    <a-popconfirm  title="确认删除该商品吗"  ok-text="确认" cancel-text="取消" @confirm="dropGoods(record)">
...
import store, { STA_GOODS, GET_GOODSTYPE, DEL_GOODSITEM } from "~/config/store.js"
...
const columns = [ 
    ...
    { title: "规格", dataIndex: "sSpec", key: "sSpec", width:120,  ellipsis: true},
    { title: "售价", dataIndex: "dPrice", key: "dPrice", width:60, sorter: (a,b) => a.dPrice-b.dPrice},
    { title: "惠价", dataIndex: "dVip", key: "dVip", width:60, sorter: (a,b) => a.dVip-b.dVip},
    { title: "成本", dataIndex: "dCost", key: "dCost", width:60, sorter: (a,b) => a.dCost-b.dCost},
